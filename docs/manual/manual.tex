...
% TODO: tela cheia da janela principal --- usar Snipping Tool
% no aneb-sim já rodando. Salvar como docs/manual/images/board_main.png
% \begin{figure}[H]
%   \centering
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{serial_demo.png}
...
% TODO: imagem do plotter --- capturar manualmente do app rodando
% (Snipping Tool) e salvar em docs/manual/images/plotter.png.
% Motivo: QtCharts segfauda quando renderizado offscreen via
% QQuickView (limitação conhecida no PyQt6 do Windows).
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=\textwidth]{plotter.png}
%   \caption{Plotter com seis traços ativos (ADC0--ADC3 e dois PWM).}
% \end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{avrdude_demo.png}
